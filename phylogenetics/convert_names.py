...
# Read the file
file_path = 'clusters_output_with_names_v5_q2_withBH.txt'
...
converter_file_path = '/lab/wengpj01/vertebrate_pipeline/20231021_run/genes_clusters_etc3.csv'
...
output_file = 'clusters_output_with_names_v5_q2_withBH_order.txt'
