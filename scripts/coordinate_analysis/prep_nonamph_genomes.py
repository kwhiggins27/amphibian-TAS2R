...
df = pd.read_csv("../../results/coordinate_analysis/match_accession_class.csv")
...
output_file_path = "../../results/coordinate_analysis/repeat/non_amph_pt1.txt"
...
for accession in selected_accessions:
    ...
    directory_path = f"../../subdirs/{accession}"
...
output_file_path1 = "../../results/coordinate_analysis/repeat/non_amph_pt2.txt"
