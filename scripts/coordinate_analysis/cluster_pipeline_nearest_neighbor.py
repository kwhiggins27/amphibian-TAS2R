...
new_directory = os.path.join("../../subdirs/", accession)
...
try:
    ...
    csv_filename = glob.glob(f'../../results/coordinate_analysis/summary_clusters_withnearest_{max_skip_str}.csv')
    print(csv_filename)
    ...
    print(f"No clusters identified for {accession}")
