...
completed="/lab/wengpj01/vertebrate_pipeline/list_complete.txt"
attempted="/lab/wengpj01/vertebrate_pipeline/list_attempted.txt"
failed="/lab/wengpj01/vertebrate_pipeline/list_failed.txt"
...
# print("Number remaining is " + str(num_remaining))
# print("Number attempted is " + str(num_attempted))
# print("Number completed is " + str(num_completed))
...
plt.savefig('/lab/wengpj01/vertebrate_pipeline/progress_bar.pdf', dpi=300, bbox_inches='tight')
