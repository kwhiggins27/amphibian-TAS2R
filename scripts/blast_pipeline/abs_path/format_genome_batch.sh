...
sbatch /lab/solexa_weng/playground/Kate_Higgins/other_vertebrates/pipeline/format_genome.sh	GCA_000225785.1_LatCha1_genomic.fna	GCA_000225785.1  Latimeria_chalumnae  coelacanth 7897 fish
