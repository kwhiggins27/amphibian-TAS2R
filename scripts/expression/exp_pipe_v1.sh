...
# Mini run for xenopus.  Not complete dataset!
species="xenopus_mini"
genome="../../references/reference_genomes/Xenopus_tropicalis_frog.fna "
GTF="../../results/expression/xenopus_from_pipeline.gtf"
Bitter_TS="../../results/expression/xenopus_mini/final_genes_7TM.csv"
summary_table="../../results/expression/xenopus_mini/xenopus_mini.csv"
go_to=1 #0 starts from beginning (star index), 1 starts with star/fc, 2 starts with python script
jobname="x_stfc"

STAR_index="../../results/expression/xenopus_mini/xenopus_star_index/"
STAR_out="../../results/expression/xenopus_mini/xenopus_star_mini/"
FC_out="../../results/expression/xenopus_mini/xenopus_FC_mini/"
...
#
# #
path_in="../../results/expression/xenopus_mini/"
...
elif [ "$species" = "xenopus_mini" ]; then
  var=(430_S22_L002)
else
