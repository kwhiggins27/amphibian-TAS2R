...
data <- read.csv("summary_manypairs_forplot.csv")  #This file has to be made by hand.  Our version is included to show formatting.
...
Species_A <- "human" #Modify
Species_B <- "marmoset"#Modify
file_path <- "pairwise/"
