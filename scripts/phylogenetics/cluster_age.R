...
tr=read.tree("/Volumes/wengpj01/amphibian-TAS2R/results/phylogenetics/Timetree_ultrametric.tre") #Modify.  This tree will need to be separately download from the manuscript's webpage

# Read the file
file_path <- "clusters_output_with_names_v7_q2_withBH.txt"
...
file_path <- "genes_clusters_etc3.csv"  # Update this path if needed
...
not_in_tree_file <- "not_in_tree.txt"
...
write.csv(cluster_table, file = "cluster_table.csv", row.names = FALSE)
