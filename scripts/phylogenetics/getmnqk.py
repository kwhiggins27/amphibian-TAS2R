...
import pandas as pd
import os
accepted_range = pd.read_csv('../../results/phylogenetics/maximal_range_all.tsv', sep='\t')  #This df is notable for columns chromosome, start, stop, accession
accepted_range['id'] = (
...
for index_A, row_A in accepted_range.iterrows():
    ...
    file_path_A = f'../../results/busco/{accession_A}/busco_output/run_vertebrata_odb10/full_table.tsv'
    ...
    for index_B, row_B in accepted_range2.iterrows():
        ...
        file_path_B = f'../../results/busco/{accession_B}/busco_output/run_vertebrata_odb10/full_table.tsv'
...
calc_m.to_csv('../../results/phylogenetics/calc_m7.csv')
calc_n.to_csv('../../results/phylogenetics/calc_n7.csv')
calc_k.to_csv('../../results/phylogenetics/calc_k7.csv')
calc_q.to_csv('../../results/phylogenetics/calc_q7.csv')
