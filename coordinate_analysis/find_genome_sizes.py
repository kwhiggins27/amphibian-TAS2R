...
my_work = pd.read_csv('/lab/wengpj01/vertebrate_pipeline/20231006_run/20231006_basics.csv', header=0)

# Read the second dataframe from genome_size_data_011123_11_59_51.csv
genome_database = pd.read_csv('/lab/wengpj01/vertebrate_pipeline/genome_size_data_011123_11_59_51.csv', header=0)
...
plt.savefig('/lab/wengpj01/vertebrate_pipeline/genome_vs_TAS2Rcount2.pdf')
