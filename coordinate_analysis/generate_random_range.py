...
def generate_random_windows(accession):
    ...
    chromsizes_path = f"/lab/wengpj01/vertebrate_pipeline/subdirs/{accession}/chromsizes.csv"
 ...
 # Check if the resulting DataFrame contains only False values
    ...
    for_bed.to_csv(f"/lab/wengpj01/vertebrate_pipeline/subdirs/{accession}/random_windows.bed", sep='\t', header=False, index=False)
