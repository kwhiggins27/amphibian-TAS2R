...
gtf_files = glob.glob(f'/lab/wengpj01/vertebrate_pipeline/subdirs/{accession}/*_from_pipeline.gtf')
...
# Use glob to match files with the specified wildcard
gtf_files = glob.glob(f'/lab/wengpj01/vertebrate_pipeline/subdirs/{accession}/*_sorted.gtf')
...
clusters_split.to_csv(f'/lab/wengpj01/vertebrate_pipeline/subdirs/{accession}/clusters_found_split_2012.csv', index=False)

# Open the CSV file for writing
csv_filename = '/lab/wengpj01/vertebrate_pipeline/20231006_run/summary_clusters_median_1012.csv'  # Change the filename as needed
