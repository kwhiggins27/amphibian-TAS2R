...
output_file = "/lab/wengpj01/vertebrate_pipeline/coordinates/position_within_chromosome_1021.csv"
output_file1 = "/lab/wengpj01/vertebrate_pipeline/coordinates/position_within_chromosome_all_genes_1021.csv"

# Read the list of accessions from all_accessions.txt
with open('/lab/wengpj01/vertebrate_pipeline/accessions_to_keep.txt', 'r') as accession_file:
        ...
        if not chrom_row.empty:
            ...
            if not chrom_row.empty:
                ...
                try:
                    ...
                    i_stop = gene_row["end"]
                    # i_mini = gene_row["chr_mini"]
                    # i_ends = gene_row["from_end"]
