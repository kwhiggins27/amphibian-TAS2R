...
touch /lab/wengpj01/vertebrate_pipeline/20231006_run/summary_clusters_withnearest_$max_skip.csv
...
python_script=/lab/solexa_weng/playground/Kate_Higgins/other_vertebrates/pipeline/cluster_pipeline_nearest_neighbor.py
